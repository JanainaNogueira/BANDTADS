-- ms conta - banco de escrita
-- Tabelas: conta, movimentacao
-- Dependências: cliente IDs 1..5, gerente IDs 1..3
...
(1, '1291', TIMESTAMP '2000-01-01 00:00:00',     800.00,  5000.00, 1),  -- Catharyna / Geniéve
(2, '0950', TIMESTAMP '1990-10-10 00:00:00', -10000.00, 10000.00, 2),  -- Cleuddônio / Godophredo
(3, '8573', TIMESTAMP '2012-12-12 00:00:00',  -1000.00,  1500.00, 3),  -- Catianna / Gyândula
(4, '5887', TIMESTAMP '2022-02-22 00:00:00', 150000.00,     0.00, 1),  -- Cutardo / Geniéve
(5, '7617', TIMESTAMP '2025-01-01 00:00:00',   1500.00,     0.00, 2);  -- Coândrya / Godophredo
